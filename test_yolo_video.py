...
###
### comments after triple sharp characters were written by KM, not original ones
###
...
import cv2  ### capture video with opencv2
...
def _main(args):
    ...
    while True:
        ...
        if args.show_fps:
            ...
            cv2.putText(OpenCV_data, text=fps, org=(3, 15), fontFace=cv2.FONT_HERSHEY_SIMPLEX, 
